/**
 * @file orb_mapping_mono.cc
 * @author Xinjiang Wang (wangxj83@sjtu.edu.cn)
 * @brief mono mapping example
 * @version 0.1
 * @date 2022-01-14
 *
...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: ./orb_mapping_mono path_to_config path_to_sequence" << endl;
        return 1;
    }
    ...
    string mapSavePath, trajSavePath;
...
// #endif
        ...
        Mapper.TrackMonocular(im,tframe);
...
// #endif
    ...
    Mapper.SaveTrajectoryTUM(TrajTUMSavePath);
    Mapper.SaveKeyFrameTrajectoryTUM(KFTrajTUMSavePath);
