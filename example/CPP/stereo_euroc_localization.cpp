...
int main(int argc, char **argv)
{
    ...
    // Localization.LoadMap("map.bin");
    Localization.LoadMapUsingBoost("map.bin");
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        // Pass the images to the Localization system
        cv::Mat Tcw = Localization.ORBLocalization(imLeftRect, tframe);
    ...
    Localization.SaveTrajectoryTUM("FrameTrajectory_Localization.txt");
