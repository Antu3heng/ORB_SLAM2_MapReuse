/**
 * @file orb_slam_node.cpp
 * @author Xinjiang Wang (wangxj83@sjtu.edu.cn)
 * @brief ros slam example 
 * @version 0.1
 * @date 2021-09-09
 * 
...
{
public:
    ImageGrabber(ORB_SLAM2_MapReuse::System *pSLAM) : mpSLAM(pSLAM) {}
    ...
    ORB_SLAM2_MapReuse::System *mpSLAM;
    bool do_rectify;
...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: rosrun orb_slam2_mapreuse orb_slam_node path_to_config" << endl;
        return 1;
    }
    ...
    string image0Topic, image1Topic, vocPath, trajSavePath, mapSavePath;
