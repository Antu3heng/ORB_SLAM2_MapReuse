...
class MapPoint
{
   ...
   void serialize(Archive &ar, const unsigned int version)
   {
        ...
        ar & mTrackProjX & mTrackProjY & mTrackProjXR;
        ar & mbTrackInView;
...
public:
    ...
    MapPoint(const cv::Mat &Pos, Map* pMap, cv::Mat &Descriptor, float fMinDistance, float fMaxDistance);
